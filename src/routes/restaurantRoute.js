...
import { checkPhoneForUser, registerRestaurant } from "../controllers/userController.js";
...
// router.get("/your-restaurants", branchController.getAllYourBranchs);
...
//item
// router.get("/items/restaurants?:restaurantid", getAllItemsByRestaurantId);
// router.get("/items/:itemid/:restaurantid", getItemByRestaurantId);
// Order
